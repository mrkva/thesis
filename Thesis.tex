%%%% Streams & Currents by Jonas Gruska
%%%% (CC) May 2013
%%%% Made for LaTeX
...
\usepackage[							% PDF metadata
	pdftex,
    pdfauthor={Jonas Gruska},
...
\usepackage{xcolor}				
\definecolor{red}{HTML}{AD1737}			% Title and link color
...
\usepackage[scaled=0.90]{inconsolata}	% Monospaced font
...
\usepackage[activate={true,nocompatibility},final,kerning=true,spacing=true,factor=1100]{microtype}
\frenchspacing
\raggedbottom
...
\begingroup
\raggedright					% References look better when ragged right
