...
\begin{figure}  
  \centering
    \tikzstyle{block} = [rectangle, draw, 
	    text width=6em, text centered, minimum height=2.5em, node distance=4.5cm, scale=0.8]
	...
	\begin{tikzpicture}[node distance = 2cm, auto]
		...
		\node [block, above of=nds, node distance=3cm] (rni) {\texttt{Router, other network users}};
	    \node [block, right of=nds] (sniffer) {\texttt{\textbf{tcpdump} \\Packet sniffer}};
		\node [block, right of=sniffer] (aplay) {\texttt{\textbf{aplay} \\ Actual sonification}};
		\node [block, below of=sniffer] (me) {\texttt{Me (Performer)}};
		...
		\path [line, rounded corners=5pt] (me) -| node [near end, above, scale=.8, rotate=90] {\texttt{Arbitrary data}} (nds);
